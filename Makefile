...
PACKAGE ?= helm-komoplane
XRD_DIR := apis/komoplanes
COMPOSITION := $(XRD_DIR)/composition.yaml
DEFINITION := $(XRD_DIR)/definition.yaml
EXAMPLE_DEFAULT := examples/komoplanes/standard.yaml
...
EXAMPLES := \
    examples/komoplanes/minimal.yaml:: \
    examples/komoplanes/standard.yaml::
...
render\:%:
	@example="examples/komoplanes/$*.yaml"; \
	up composition render --xrd=$(DEFINITION) $(COMPOSITION) $$example
